 ...
 * @returns {string} random string for use as user ID
 */
const generateId = () => {
 ...
 * @returns {boolean} email is already in use or not
 */
 ...
 * @returns {object|undefined} the user matches with email and password
 */
 ...
 * @returns {object|undefined} user matches with the ID
 */
